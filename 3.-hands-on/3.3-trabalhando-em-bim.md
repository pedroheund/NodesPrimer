...
{% hint style="info" %}
Atualmente, apenas os nós de esforços utilizam combinação cruzada.
{% endhint %}

Mesmo que o tipo de amarração ainda não possa ser alterado manualmente, entender como cada nó combina suas entradas ajuda a prever o comportamento do fluxo e a criar estruturas mais eficientes e coerentes dentro do Nodes.
